          ...
          <div className="items-center lg:flex">
            <div className="w-full lg:ml-10 lg:w-1/2">
              <div  className="lg:max-w-lg">
                <h1 data-aos="fade-up"
                  data-aos-duration="2000" className=" font-semibold  text-[#ff4880]">
                  --- DONATION <br />{" "}
                  <span data-aos="fade-up"
                  data-aos-duration="2000" className="text-[#ff4880] lg:text-4xl text-3xl">
                    YOUR MONEY SAVES LIVES
                  </span>
                </h1>

                <p data-aos="fade-up"
                  data-aos-duration="2000" className="mt-3 dark:text-black">
                ...
                <Link data-aos="fade-up"
                  data-aos-duration="2000" to="/campaign" className="pt-10">
                  <a
                    href="#_"
            ...
            <div data-aos="fade-up"
                  data-aos-duration="2000" className="flex items-center justify-center w-full mt-6 lg:mt-0 lg:w-1/2">
              <img
