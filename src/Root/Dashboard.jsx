      ...
      <div className="flex max-w-screen-xl lg:w-full mx-auto ">
        ...
        <div className="absolute block md:block lg:hidden">
          <div className="text-center">
            <button className="mt-7 ml-7" type="button" onClick={toggleDrawer}>
              <svg
                ...
                <>
                  <NavLink to="/dashboard/users">
                    ...
                    >
                      ...
                      <span className="relative invisible">All Users</span>
                    </a>
                  </NavLink>
                  ...
                  <NavLink to="/dashboard/admin/AllDonation">
                    ...
                    >
                      ...
                      <span className="relative invisible">All Donation</span>
                    </a>
                  </NavLink>
