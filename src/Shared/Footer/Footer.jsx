const Footer = () => {
	...
	<div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
		<div className="lg:w-1/3">
			<a data-aos="fade-top" data-aos-duration='2000' rel="noopener noreferrer" href="#" className="flex justify-center space-x-3 lg:justify-start">
				...
				<span  className="self-center text-2xl lg:text-3xl font-semibold"><span className="text-pink-700">LAFSE</span> PEAT</span>
			</a>
		</div>
